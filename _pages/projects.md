...
Additionally, some bugs are labeled incorrectly in Jira, so they are missing from queries and not included in the RN. Communication is the key to finding mislabeled bugs. Engineering and review teams are familiar with each bug recorded in this release and can more easily spot high-value bugs that are missing in the RN. 
 
## Release Notes Sample
[Release Notes Sample](/rel_notes_example/)

# User Guide: Procedures and Concepts
...
## Documents
Provide a list of documents where I would write procedures: User Guides, Configuration Guides, etc.

## User Guide Sample
[User Guide Sample](/how_to_example/)
...
## Toolchain
I created this procedure in Confluence. The Technical Publications team created all internal content on Confluence.
...
## Internal Wiki Procedure Sample
[Wiki Procedure Sample](/internal_wiki/)